...
export class FormLayoutsPage extends HelperBase{  // extending with helper class
     ...
     * @param email - valit email for the test user
    ...
    async submitInlineFormWithNameEmailAndCheckbox(name: string, email: string, rememberMe: boolean){
        ...
        if(rememberMe) // we can skip specifing rememberMe == true
